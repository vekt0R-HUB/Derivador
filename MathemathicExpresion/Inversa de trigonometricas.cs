...
public class Arcsen:UnaryExpresion
{
    ...
    //arcsen'(f)= f'/(1-f)^(1/2)
    {
        ...
        (1-new Pow(new Pow(InternalExpresion,2),0.5));
    }
...
public class Arctangent:UnaryExpresion
{
    ...
    //arctan'(f)= f'/(1+f^2)
    {
        ...
        if(variable=='\0')
            return 0;
        return InternalExpresion.DerivateInVariable(variable)/(1+new Pow(InternalExpresion,2));
    }
    public override Expresion Symplify()
    {
        Expresion Internal=InternalExpresion.Symplify();
...
public class Arcsecant:UnaryExpresion
{
    ...
    //arcsec'(f)= f'/(f(1-f)^(1/2))
    {
        ...
        new Pow((1-new Pow(InternalExpresion,2)),0.5);
    }
    public override Expresion Symplify()
    {
        Expresion Internal=InternalExpresion.Symplify();
...
public class Arccotangent:UnaryExpresion
{
    ...
    //arccot'(f)= -f'/(1+f^2)
    {
        ...
        if(variable=='\0')
            return 0;
        return -InternalExpresion.DerivateInVariable(variable)/new Pow(1+InternalExpresion,2);
    }
    public override Expresion Symplify()
    {
        Expresion Internal=InternalExpresion.Symplify();
