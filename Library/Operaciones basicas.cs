...
public class Sum : BinaryExpresion
{
    ...
    public override double GetValue() => LeftExpresion.GetValue() + RigthExpresion.GetValue();
    public override Expresion Evaluate(char variable, double valor) => LeftExpresion.Evaluate(variable, valor) + RigthExpresion.Evaluate(variable, valor);
}
