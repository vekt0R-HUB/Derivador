...
//A mathematic expresion
{
    ...
    static public Expresion operator +(Expresion a, Expresion b) => new Sum(a, b);
    static public Expresion operator -(Expresion a, Expresion b) => new Diference(a, b);
    static public Expresion operator -(Expresion a) => -1 * a;
    static public Expresion operator *(Expresion a, Expresion b) => new Multiplication(a, b);
    static public Expresion operator /(Expresion a, Expresion b) => new Divition(a, b);
    public static implicit operator Expresion(double a) => new Constant(a);
...
public abstract class UnaryExpresion : Expresion
{
    ...
    public override char GetAVariable() => InternalExpresion.GetAVariable();

    public override string ToString() => ExpresionOperator + "(" + InternalExpresion.ToString() + ")";
}
